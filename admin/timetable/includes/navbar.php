...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!-- <a class="collapse-item" href="add_student.php">Add Students</a> -->
...
<li class="nav-item">
            ...
            <a class="collapse-item" href="../notice.php">Add Notice</a>  
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <h6 class="collapse-header">Time table Section :</h6>
            <a class="collapse-item" href="timetable/time_table.php">Add Time Table</a>  
                    </div>
                </div>
            </li>
