...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO teacher_data (u_card, u_f_name, u_l_name, u_father, u_mother, u_aadhar, u_birthday, u_gender, u_email, u_phone, u_state, u_dist,  u_pincode, qualification,subject, password, image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_mother','$u_aadhar','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_pincode','$qual', '$subject','$pass','$image',NOW())";
	...
	if($added){
		echo "
			<div class='btn-success' style='padding: 15px; text-align:center;'>
				Your Teacher Data has been Successfully Added.
			</div><br>
		";
	}
...
<br>
  ...
  <hr>
		...
		<thead>
        	...
        	$get_data = "SELECT * FROM teacher_data order by 1 desc";
...
<input type="text" class="form-control" name="card_no" placeholder="Enter 12-digit Teacher Id." maxlength="12" required>
</div>
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
<label for="inputqualification">Teacher qualification(separated by commas)</label>
<input type="text" class="form-control" name="qualification">
</div>
<div class="form-group col-md-6">
<label for="inputsubject">Teacher Subject</label>
...
$get_data = "SELECT * FROM teacher_data";
$run_data = mysqli_query($conn,$get_data);
