    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Teacher ID:</strong><?php echo $card; ?></p>
            <p class="mb-0"><strong class="pr-1">Teacher Name:</strong><?php echo $name ; ?></p>
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="far fa-clone pr-1"></i>Teacher Information</h3>
          </div>
